...
@pytest.mark.ui
def test_argocd_login_via_github(attach_screenshot, github_credentials, captain_domain):
    """
    ...
    try:
        ...
        if "/applications" not in page.url:
            ...
            take_screenshot(page, "ArgoCD Wrong Page", attach_screenshot)
            raise Exception(f"Failed to reach applications page. Current URL: {page.url}")
        
        log.info("Applications page fully loaded, taking screenshot...")
        
        # Take screenshot of ArgoCD applications page
